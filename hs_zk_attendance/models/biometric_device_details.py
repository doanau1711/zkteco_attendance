    ...
    def action_download_attendance(self):
        ...
        for info in self:
            ...
            if conn_1:
                ...
                # print("====>attendance: ", attendance_1)
                # if attendance_1 or attendance_2 or attendance_5:
                _logger.info('valueattendance:',attendance_1)
                if attendance_1:
                    ...
                    for attendance in [attendance_1]:
                        if attendance:
                            for each in attendance:
                                ...
                                if atten_time.tzinfo is None:
                                    local_tz = pytz.timezone('Asia/Ho_Chi_Minh')  
                                    local_dt = local_tz.localize(atten_time)  
                                else:
                                    local_dt = atten_time.astimezone(pytz.timezone('Asia/Ho_Chi_Minh'))  
